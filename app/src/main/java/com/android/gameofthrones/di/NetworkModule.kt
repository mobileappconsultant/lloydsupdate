...
import com.android.gameofthrones.data.source.remote.RemoteDataSourceImpl
import com.android.gameofthrones.utils.DefaultDispatcherProvider
...
open class NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideAPI(retrofit: Retrofit): GOTApi {
